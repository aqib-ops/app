...
export function WhatsAppChatButton() {
  return (
    <div className="pointer-events-none fixed bottom-5 right-4 z-[70] sm:bottom-7 sm:right-6">
      <a
        href={CHAT_LINK}
        target="_blank"
        rel="noreferrer"
        aria-label="Start a WhatsApp chat about your project"
        className="group pointer-events-auto relative inline-flex items-center gap-3 rounded-full border border-white/40 bg-white/95 px-3 py-3 pr-4 text-black shadow-[0_14px_40px_rgba(2,12,10,0.45)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_48px_rgba(0,140,116,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--mint)] focus-visible:ring-offset-2 focus-visible:ring-offset-[#05080a]"
      >
        <span
          aria-hidden
          className="absolute -inset-1 -z-10 rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(37,211,102,0.42),rgba(0,0,0,0))] blur-sm transition-opacity duration-300 group-hover:opacity-100"
        />
        <span className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[inset_0_-8px_20px_rgba(0,0,0,0.24)]">
          <span aria-hidden className="absolute -right-0.5 -top-0.5 flex h-3.5 w-3.5">
            ...
            <span className="relative inline-flex h-3.5 w-3.5 rounded-full border border-white bg-[#12b956]" />
          </span>
        ...
        <span className="hidden sm:flex sm:flex-col sm:leading-tight">
          ...
          <span className="text-[11px] font-medium text-black/60">Discuss your project now</span>
        </span>
      </a>
    </div>
  );
